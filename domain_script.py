...
if __name__ == "__main__":
    ...
    if args[-1]:
        print(
            '-s, --start\tThe start string of domain name. Example: you want to search from "abc.com", set start to be "abc".'
        )
        print(
            '-e, --endings\tA list of Top Level Domains. Example: you are interested in ".com" and "io", set endings to be "com,io".'
        )
        print(
            "-i, --interval\tThe interval of sending requests, in seconds. Example: you want request to be sent every 2 seconds, set interval to be 2."
        )
